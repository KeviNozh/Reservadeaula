...
ALLOWED_HOSTS = [
    '100.26.77.138',  # IP pública de la EC2
    'localhost'
]
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': os.environ.get('DB_PASSWORD'),         # Tu contraseña (reemplaza por variable de entorno en producción)
        'HOST': 'database-1.cbashmzloilr.us-east-1.rds.amazonaws.com',
        'PORT': '5432',
    }
}   
