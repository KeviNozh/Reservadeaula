...
DATABASES = {
    'default': {
        ...
        'PASSWORD': '123456', # Tu contraseña (reemplaza por variable de entorno en producción)
        'HOST': 'localhost',
        'PORT': '5432',
    }
}   
...
# Deshabilita CSRF temporalmente para diagnóstico (SOLO DESARROLLO)
