        ...
        try:
            ...
            if user is not None and user.is_active:
                try:
                    ...
                    # 🔔 NOTIFICAR LOGIN DE ADMINISTRADOR
                    if is_admin_login and perfil.rol in admin_roles:
                        try:
...
def actualizar_espacio_api(request, espacio_id):
    ...
    try:
        ...
        # 🔔 NOTIFICAR A ADMINISTRADORES SOBRE ACTUALIZACIÓN DE ESPACIO
        try:
            notificar_accion_admin(
            ...
            print(f"📢 Notificación admin creada para actualización de espacio {espacio.id}")
        except Exception as admin_notif_error:
            print(f"⚠️ Error en notificación admin actualización espacio: {admin_notif_error}")
