...
urlpatterns = [
    ...
    # API - Testing (solo desarrollo)
    path('api/test-notificaciones-reales/', views.test_notificaciones_reales, name='test_notificaciones_reales'),
    path('api/limpiar-notificaciones-prueba/', views.limpiar_notificaciones_prueba, name='limpiar_notificaciones_prueba'),
    
    # API - Notificaciones tiempo real
    path('api/crear-notificacion-tiempo-real/', views.crear_notificacion_tiempo_real, name='crear_notificacion_tiempo_real'),
]