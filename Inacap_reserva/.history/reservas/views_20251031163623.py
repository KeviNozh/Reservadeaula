...
def notificar_accion_admin(tipo, titulo, mensaje, usuario_admin=None, usuario_relacionado=None, reserva=None, espacio=None, request=None):
    """
    Función MEJORADA para notificaciones administrativas con datos REALES
    """
    try:
        print(f"🚀 CREANDO NOTIFICACIÓN ADMIN CON DATOS REALES")
        print(f"   📝 Tipo: {tipo}")
        ...
        print(f"   ✅ NOTIFICACIÓN REAL CREADA EN BD: ID {notificacion.id}")
        return notificacion
...
def registro_usuario(request):
    ...
    if request.method == 'POST':
        try:
            ...
            print(f"🎯 REGISTRO_USUARIO: Usuario creado - {user.username}")
            ...
            print(f"🎯 REGISTRO_USUARIO: Perfil creado para {user.username}")

             # 🔔 NOTIFICAR NUEVO USUARIO REGISTRADO - CON DEBUG
            ...
            try:
                ...
                print(f"🎯 REGISTRO_USUARIO: Notificación admin CREADA para {user.username}")
            except Exception as admin_notif_error:
...
def crear_reserva_api(request):
    ...
    if request.method == 'POST':
        try:
            ...
            # 🔔 NOTIFICAR A ADMINISTRADORES SOBRE NUEVA RESERVA REAL
            try:
                notificar_accion_admin(
                    tipo='reserva_creada',
                ...
                print(f"📢 Notificación admin REAL creada para nueva reserva {reserva.id}")
            except Exception as admin_notif_error:
...
def crear_espacio_api(request):
    ...
    try:
        ...
        print(f"✅ Espacio REAL creado: ID {espacio.id} - {espacio.nombre}")
        ...
        try:
            ...
            print(f"📢 Notificación admin REAL creada para nuevo espacio {espacio.id}")
        except Exception as admin_notif_error:
