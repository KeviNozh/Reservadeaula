...
class ElementoReserva(models.Model):
    ...
    def __str__(self):
        return f"{self.cantidad}x {self.elemento.nombre} para Reserva #{self.reserva.id}"
...
class Reserva(models.Model):
    ...
    observaciones_elementos = models.TextField(blank=True, null=True)
    ...
    # Campos adicionales de aprobación
