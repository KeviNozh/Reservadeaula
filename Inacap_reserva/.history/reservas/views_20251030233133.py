...
def crear_espacio_api(request):
    """API PARA CREAR ESPACIO - VERSIÓN MEJORADA CON DEBUGGING"""
    print("=" * 50)
    ...
    try:
        ...
        try:
            ...
            return JsonResponse({'success': False, 'error': f'Error en formato JSON: {str(e)}'})
        ...
        try:
            ...
            return JsonResponse({'success': False, 'error': f'Error al guardar en la base de datos: {str(e)}'})
